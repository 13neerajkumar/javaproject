    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!user_name.equals("") && !password.equals("") && !phn.equals("") && !add.equals("") && !gender.equals(""))
        {
            try
            {
                ...
                PreparedStatement pstmt=con.prepareStatement("delete from std_login where `s_user_name`=?");
                ...
                {
                    JOptionPane.showMessageDialog(null,"Student NOT Deleted Successfully ...!!!!");
                }
            }
            catch (Exception e) 
            {
