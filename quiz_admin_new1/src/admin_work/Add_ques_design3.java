 ...
 * @author gaurav_verma
 */
public class Add_ques_design3 extends javax.swing.JFrame {
    ...
    public Add_ques_design3(String q_type,String q_level) 
    {
        this.q_type=q_type;
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(580, 290, 210, 30);
        ...
        jTextField3.setBounds(580, 330, 210, 30);
        ...
        jTextField4.setBounds(580, 370, 210, 30);
        ...
        jScrollPane1.setBounds(580, 170, 210, 100);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            pstmt.setString(4,opt_a);
            pstmt.setString(5,opt_b);
            pstmt.setString(6,opt_c);
            pstmt.setString(7,opt_d);
            ...
            {
                JOptionPane.showMessageDialog(null,"Question NOT Added Successfully ...!!!!");
            }
        }
        catch (Exception e) 
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_ques_design3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_ques_design3("","").setVisible(true);
            }
        });
    }
