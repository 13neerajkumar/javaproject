 ...
 * @author gaurav_verma
 */
public class update_ques_design1 extends javax.swing.JFrame {
    ...
    public update_ques_design1(String q_type,String q_level) 
    {
        this.q_type=q_type;
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(200, 190, 100, 20);
        ...
        jLabel8.setBounds(200, 560, 125, 30);
        ...
        jLabel12.setBounds(200, 280, 72, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement pstmt=con.prepareStatement("update my_ques_work set `ques`=? , `option_a`=? , `option_b`=? , `option_c`=? , `option_d`=? , `ans`=? where `q_id`=? and `type`=? and `level`=?");
            
            pstmt.setString(1,ques);
            pstmt.setString(2,opt_a);
            pstmt.setString(3,opt_b);
            pstmt.setString(4,opt_c);
            pstmt.setString(5,opt_d);
            pstmt.setString(6,ans);
            pstmt.setString(7,q_id);
            pstmt.setString(8,q_type);
            pstmt.setString(9,q_level);
            ...
            {
                JOptionPane.showMessageDialog(null,"Question NOT Updated Successfully ...!!!!");
            }
        }
        catch (Exception e) 
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_ques_design1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_ques_design1("","").setVisible(true);
            }
        });
    }
